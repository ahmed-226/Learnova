...
const DashboardStats = ({ userData }) => {
  const stats = [
    ...
    },
    {
      ...
      textColor: 'text-secondary-700 dark:text-secondary-400',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    {
      title: 'Certificates',
      value: userData.certificatesEarned,
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      {stats.map((stat, index) => (
        <div key={index} className={`card flex items-center ${stat.bgColor}`}>
          <div className={`rounded-md p-3 mr-4 ${stat.textColor}`}>
            {stat.icon}
          </div>
          <div>
